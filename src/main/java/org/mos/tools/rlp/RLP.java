...
import org.mos.tools.bytes.BytesDecodeResult;
...
import static org.mos.tools.bytes.BytesHelper.*;
...
public class RLP {
	...
	public static byte[] encode(Object input) {
		RLPValue val = new RLPValue(input);
		if (val.isList()) {
...
//	}
	...
	private static byte[] toBytes(Object input) {
		...
		} else if (input instanceof RLPValue) {
			RLPValue val = (RLPValue) input;
